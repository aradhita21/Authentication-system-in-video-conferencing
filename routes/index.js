...
app.get('/client',isLoggedIn,(req,res)=>{ // if app gets "/" and is logged in
console.log("req user",req.user);// print user details
res.render('client',{ // response by rendering to home.handlebars
    user : req.user });// and give user details
});

app.get('/streamer',isLoggedIn,(req,res)=>{ // if app gets "/" and is logged in
console.log("req user",req.user);// print user details
res.render('streamer',{ // response by rendering to home.handlebars
    user : req.user });// and give user details
});
